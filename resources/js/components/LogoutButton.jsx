...
function LogoutButton(props) {
    ...
    return (
        <>
            <button title='log out' onClick={ toggleModal } className='flex flex-col justify-center items-center hover:brightness-125'>
                ...
                <span className='text-red-500 text-xs hidden md:inline-block'>Log out</span>
            </button>
